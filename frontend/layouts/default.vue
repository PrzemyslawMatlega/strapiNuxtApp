  ...
  <div>
    ...
    <nav class="uk-navbar-container" uk-navbar>
        ...
        <div class="uk-navbar-right">
          <ul class="uk-navbar-nav">
              <li v-for="category in kategorias" :key="category.id">
          
                <router-link :to="{ name: 'categories-id', params: { id: category.id }}" tag="a">{{ category.Nazwa }}
                </router-link>
              </li>
          </ul>
        </div>
            ...
            <div class="uk-grid-collapse uk-child-width-1-2@s uk-flex-middle" uk-grid>
                ...
                <div class="uk-padding-large">
                    ...
                    <div class="uk-width-1-2@s">
                       ...
                       <li v-for="category in kategorias" :key="category.id">
                            <router-link class="uk-modal-close" :to="{ name: 'categories-id', params: { id: category.id }}" tag="a">{{ category.Nazwa }}
                            </router-link>
                          </li>
                        </ul>
                    </div>
                    <p class="uk-text-light">Built with strapi and Nuxt</p>
                </div>
            </div>
        </div>
    </div>
